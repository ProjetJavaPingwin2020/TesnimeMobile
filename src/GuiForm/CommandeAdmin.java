 ...
 * @author ASUS
 */
public class CommandeAdmin extends BaseForm{
   
     ServiceBoutique serviceTask = new ServiceBoutique();
            ArrayList<Commande> lis = serviceTask.consultercommande2(); //liste des Produits
            Container cCenter = new Container();
             private Form current;
                     
    public CommandeAdmin(Form previous) throws ParseException {
      ...
      super("", BoxLayout.y());
        ...
        Button btnClose = new Button("Espace Admin: Liste des Ratings");
        btnClose.setIcon(
  ...
  private void populateScreen(Container cnt) throws ParseException {
      ...
      cnt.setScrollableY(true);
       ...
       for(Commande c : lis) {
           cnt.addComponent(new AccrClient3(c));
           cnt.setScrollableY(true);
       }
       cnt.repaint();
    }
 ...
 class AccrClient3 extends Accordion {
      ServiceBoutique serviceTask = new ServiceBoutique();
      private Resources theme=UIManager.initFirstTheme("/theme");
       ...
       Container c3 = new Container();
        public AccrClient3(Commande cp) throws ParseException {
            super();
            this.cp = cp;
            addContent(
...
l=s1.login(); //traja3l
           ...
           Label s = new Label("Commande de  :"+cp.getNom_client());
        ...
        private Container createDetail(Commande cp) throws ParseException {
           ...
           valider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                    ...
                    con.setUrl("http://localhost/integration/test1.1/web/app_dev.php/user/validcom?"
                            +"id="+cp.getId()
                            //+"&quantite="
             ...
             con.addResponseListener(new ActionListener<NetworkEvent>() {
                        ...
                        serviceTask.mail(cp.getId());
                            ...
                            Form current = null;
                                ...
                                new CommandeAdmin(current).show();
  ...
  BrowserComponent  browser = new BrowserComponent();
        ...
        browser.setURL("http://localhost/integration/test1.1/web/app_dev.php/admin/pdfmob?"+
                "id="+cp.getId());
