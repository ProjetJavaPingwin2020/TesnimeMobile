 ...
 * @author bhk
 */
public class ProduitsAdmin extends BaseForm{
    ...
    public ProduitsAdmin(Form previous) throws ParseException {
       super("", BoxLayout.y());
 ...
 class AccrClient2 extends Accordion {
      ...
      private Resources theme=UIManager.initFirstTheme("/theme");
       ...
       Container c3 = new Container();
        public AccrClient2(Produit c) throws ParseException {
            super();
        ...
        private Container createHeader(Produit c) {
            ...
            EncodedImage placeholder=EncodedImage.createFromImage(theme.getImage("200.gif"),true);
                ...
                System.out.println(c.getNomimage());
                                       URLImage Urlimg=URLImage.createToStorage(placeholder,"http://localhost/pidev/web/imageProduits/"+ c.getNomimage(),"http://localhost/pidev/web/imageProduits/"+ c.getNomimage());
        ...
        private Container createDetail(Produit c) throws ParseException {
                   ...
                   TextField  quantitecom= new TextField("");
