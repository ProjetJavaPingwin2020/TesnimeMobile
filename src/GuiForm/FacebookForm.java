...
public class FacebookForm extends com.codename1.ui.Form {
    ...
    public FacebookForm(com.codename1.ui.util.Resources resourceObjectInstance) {
    ...
    private void showIfNotLoggedIn(FacebookForm form) {
        try {
            ...
            Image img = Image.createImage("/bla.jpg"); 
            myPic.setIcon(img);
            ...
            try {
                FaceBookAccess.getInstance().getUser("me", me, new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent evt) {
                        ...
                        URLImage background = URLImage.createToStorage(placeholder, "wms.png",
